 ...
 *****************************************************************************/
static void
purple_keychain_access_init(G_GNUC_UNUSED PurpleKeychainAccess *keychain_access)
{
}
...
static void
purple_keychain_access_class_finalize(G_GNUC_UNUSED PurpleKeychainAccessClass *klass)
{
}
