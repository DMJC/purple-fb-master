...
#if PURPLE_VERSION_MAX_ALLOWED < PURPLE_VERSION_2_3
#define PURPLE_AVAILABLE_IN_2_3 PURPLE_UNAVAILABLE(2, 3)
#define PURPLE_AVAILABLE_TYPE_IN_2_3 PURPLE_UNAVAILABLE_TYPE(2, 3)
#else
#define PURPLE_AVAILABLE_IN_2_3 _PURPLE_EXTERN
#define PURPLE_AVAILABLE_TYPE_IN_2_3
#endif
...
#if PURPLE_VERSION_MAX_ALLOWED < PURPLE_VERSION_2_5
#define PURPLE_AVAILABLE_IN_2_5 PURPLE_UNAVAILABLE(2, 5)
#else
#define PURPLE_AVAILABLE_IN_2_5 _PURPLE_EXTERN
#endif
...
#if PURPLE_VERSION_MAX_ALLOWED < PURPLE_VERSION_2_6
#define PURPLE_AVAILABLE_IN_2_6 PURPLE_UNAVAILABLE(2, 6)
#define PURPLE_AVAILABLE_STATIC_INLINE_IN_2_6 PURPLE_UNAVAILABLE_STATIC_INLINE(2, 6)
#define PURPLE_AVAILABLE_TYPE_IN_2_6 PURPLE_UNAVAILABLE_TYPE(2, 6)
#else
#define PURPLE_AVAILABLE_IN_2_6 _PURPLE_EXTERN
#define PURPLE_AVAILABLE_STATIC_INLINE_IN_2_6
#define PURPLE_AVAILABLE_TYPE_IN_2_6
#endif
...
#if PURPLE_VERSION_MAX_ALLOWED < PURPLE_VERSION_2_7
#define PURPLE_AVAILABLE_IN_2_7 PURPLE_UNAVAILABLE(2, 7)
#else
#define PURPLE_AVAILABLE_IN_2_7 _PURPLE_EXTERN
#endif
